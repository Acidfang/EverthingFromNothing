...
export const PROVENANCE: readonly ProvenanceNode[] = Object.freeze([
  ...
  },
  {
    ...
    label: "THIS / IS-NOT-THIS",
    status: "DERIVED",
    parents: ["first-difference"],
    reason: "One Difference has two presentations at the same reference; no geometry is imported.",
    resolution: record("FIRST DIFFERENCE", "PRESENT BOTH SIDES AT ONE REFERENCE", "THIS / IS-NOT-THIS", "M1", "WHITEPAPER ADMISSION ORDER", "TWO PRESENTATIONS RETAINED"),
  },
  {
    id: "orientation-change",
    label: "NON-ZERO ORIENTATION",
    status: "DERIVED",
    parents: ["two-presentations"],
    reason: "Orientation changes while retaining the reference; translation would require an unadmitted destination and path.",
    resolution: record("TWO PRESENTATIONS", "RETAIN ε(G) > 0", "ORIENTATION REMAINDER", "M2", "WHITEPAPER ROTATION TEST", "REFERENCE RETAINED; REMAINDER ADDRESSABLE"),
  },
  {
    id: "first-closure",
    label: "WAVE / MEDIUM",
    status: "DERIVED",
    parents: ["orientation-change"],
    reason: "The allowance resolving between the two oriented presentations is the first closure, viewed as wave and medium.",
    resolution: record("ORIENTATION REMAINDER", "RESOLVE ALLOWANCE", "FIRST WAVE / LOCAL MEDIUM", "M3", "WHITEPAPER MINIMUM CLOSURE", "CLOSURE RETAINED FOR RECURSION"),
  },
  {
    id: "recurrence-required",
    label: "RECURRENCE REQUIRED",
    status: "DERIVED",
    parents: ["first-closure"],
